...
./crawler_launcher -cid StdProductCrawler -pp /data/ingest/canary/UTSW_GeneExpressionRawDataZipped -fm http://localhost:9000 -ct gov.nasa.jpl.oodt.cas.filemgr.datatransfer.LocalDataTransferFactory -mfx xml -ais DeleteDataFile
